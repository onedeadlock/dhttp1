...
namespace Dhttp::Common::scalar
{
    ...
    inline umax_t _cmplt(umax_t v)
    {
        ...
        return (a - (v & Constants::max_c7f)) & (~v & Constants::max_c80);
    }
    ...
    inline umax_t _cmpgt(umax_t v)
    {
        ...
        constexpr umax_t a = _dup(0x7f - A);
        return (v | (a + (v & Constants::max_c7f))) & Constants::max_c80;
    }
    ...
    inline umax_t non_printable(umax_t v)
    {
        ...
        static constexpr umax_t u = Constants::max_c80 | Constants::max_c20;
